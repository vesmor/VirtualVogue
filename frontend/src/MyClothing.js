...
const MyClothing = () => {
  ...
  return (
    ...
    <Modal show={showModal} onHide={handleClose} centered>
      ...
      <Container fluid className="clothingContainer">
        <Row>
        ...
        <Col md={2} className="LeftBar">
            <Row className="d-flex flex-column"> {/* Set flex-direction to column */}
                ...
                <Card className="IconCards" style={{backgroundColor: dressIconColor ? "#71816D" : "white" }} >
                ...
                <Card className="IconCards" style={{backgroundColor: pantsIconColor ? "#71816D" : "white" }}>
                    <Card.Body className="d-flex justify-content-center align-items-center" onClick={() =>selectClothIcon(3)}>
                        <GiArmoredPants className="cloth-icon" />
                    </Card.Body>
                </Card>

                <Button type="button" className="uploadButton" background size="lg" onClick={handleShow}>New Cloth</Button>
            </Row>
        </Col>
